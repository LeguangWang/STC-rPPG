...
from nets.models.DeepPhys__ import DeepPhys
...
# from nets.models.PhysNet import PhysNet_LSTM
from nets.models.FiLM_Phys import FiLM
from nets.models.HrCNN import HrCNN
from nets.models.PhysNet_GC import PhysNet_GC
from nets.models.HrCNN_GC import HrCNN_GC
from nets.models.Rnet import Rnet
...
def get_model(model_name: str = "DeepPhys"):
    ...
    if model_name == "DeepPhys":
        ...
        return PhysNet()
    elif model_name == "PhysNet_GC" :
        return PhysNet_GC()
    elif model_name == "HrCNN":
        return HrCNN()
    elif model_name == "HrCNN_GC":
        return HrCNN_GC()
